...
- Use Alexa routines for mode phrases instead of relying on direct scene-name parsing.
- Keep scene names unique and specific (for example: "Hydros Feed Scene", "Hydros Maintenance Scene").
- After exposure/name changes, run Alexa discovery again.

This avoids common intent collisions where Alexa routes "turn on ..." or "set ..." to TVs or similarly named devices.
